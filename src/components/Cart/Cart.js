        ...
        <>
            ...
            {/* <div className="cart">
                ...
                <div className="cart__products">
                    <img className="cart__product-image" src={dish.image} alt="Фото заказанного товара" />
                    <p className="cart__product-name">{dish.short_name_rus}</p>
                    <div className="cart__container-count">
                        <p className="cart__product-price">{dish.final_price} RSD</p>
                        <button
                            aria-label="Плюс"
                            type="button"
